...
overlap = {
    (Variable(2, 1, "down", 5), Variable(1, 12, "down", 7)): None,
...
arcs = [
    (Variable(2, 1, "across", 12), Variable(2, 1, "down", 5)),
    (Variable(2, 1, "across", 12), Variable(1, 12, "down", 7)),
    (Variable(2, 1, "across", 12), Variable(1, 7, "down", 7)),
    (Variable(2, 1, "across", 12), Variable(4, 4, "across", 5)),
    (Variable(6, 5, "across", 6), Variable(2, 1, "across", 12)),
    (Variable(6, 5, "across", 6), Variable(2, 1, "down", 5)),
    (Variable(6, 5, "across", 6), Variable(1, 12, "down", 7)),
    (Variable(6, 5, "across", 6), Variable(1, 7, "down", 7)),
    (Variable(6, 5, "across", 6), Variable(4, 4, "across", 5)),
    (Variable(2, 1, "down", 5), Variable(2, 1, "across", 12)),
    (Variable(2, 1, "down", 5), Variable(6, 5, "across", 6)),
    (Variable(2, 1, "down", 5), Variable(1, 12, "down", 7)),
    (Variable(2, 1, "down", 5), Variable(1, 7, "down", 7)),
    (Variable(2, 1, "down", 5), Variable(4, 4, "across", 5)),
    (Variable(1, 12, "down", 7), Variable(2, 1, "across", 12)),
    (Variable(1, 12, "down", 7), Variable(6, 5, "across", 6)),
    (Variable(1, 12, "down", 7), Variable(2, 1, "down", 5)),
    (Variable(1, 12, "down", 7), Variable(1, 7, "down", 7)),
    (Variable(1, 12, "down", 7), Variable(4, 4, "across", 5)),
    (Variable(1, 7, "down", 7), Variable(2, 1, "across", 12)),
    (Variable(1, 7, "down", 7), Variable(6, 5, "across", 6)),
    (Variable(1, 7, "down", 7), Variable(2, 1, "down", 5)),
    (Variable(1, 7, "down", 7), Variable(1, 12, "down", 7)),
    (Variable(1, 7, "down", 7), Variable(4, 4, "across", 5)),
    (Variable(4, 4, "across", 5), Variable(2, 1, "across", 12)),
    (Variable(4, 4, "across", 5), Variable(6, 5, "across", 6)),
    (Variable(4, 4, "across", 5), Variable(2, 1, "down", 5)),
    (Variable(4, 4, "across", 5), Variable(1, 12, "down", 7)),
    (Variable(4, 4, "across", 5), Variable(1, 7, "down", 7)),
]
...
assign = {
    ...
    Variable(1, 7, "down", 7): {"NETWORK", "RESOLVE", "INITIAL", "BREADTH", "MINIMAX"},
}
